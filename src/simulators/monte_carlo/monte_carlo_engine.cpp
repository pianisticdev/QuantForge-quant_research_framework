...
namespace simulators {
    MonteCarloEngine::MonteCarloEngine(const plugins::loaders::IPluginLoader* plugin, const forge::DataStore* data_store)
    ...
    const MonteCarloReport& MonteCarloEngine::get_report() { return report_; }
